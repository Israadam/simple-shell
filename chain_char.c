...
/**
 * _chaintst - test if current char in buffer is a chain delimeter
 ...
 */
int _chaintst(info_t *info, char *buf, size_t *w)
{
size_t j = *w;
...
/**
 * reputl_string - replaces string
 * @old: address of old string
 * @low: new string
 * Return: 1 if replaced, 0 otherwise
 */
int reputl_string(char **old, char *low)
{
free(*old);
*old = low;
return (1);
 ...
 * Return: Void
 */
void chain_check(info_t *info, char *buf, size_t *w, size_t i, size_t len)
{
size_t j = *w;
