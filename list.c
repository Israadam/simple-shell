...
=======
 * add_nodestar - adds a node to the start of the list
...
list_t *add_node(list_t **head, const char *str, int num)
{
	list_t *new_head;
=======
list_t *add_nodestar(list_t **head, const char *str, int num)
{
list_t *new_head;
if (!head)
return (NULL);
...
/**
 * free_listnode - frees all nodes of a list
 * @head_ptr: address of pointer to head node
 * Return: void
 */
void free_listnode(list_t **head_ptr)
{
list_t *node, *next_node, *head;
