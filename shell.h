...
/**
 *struct pass_data - contains pseudo-arguements to pass into a function,
...
/* my_history.c */
char *get_history(info_t *data);
int writing_history(info_t *data);
int reading_history(info_t *data);
int build_history(info_t *data, char *buf, int line_count);
int renumbering_history(info_t *data);
...
list_t *start_with(list_t *, char *, char);
...
/* built_in2.c */
int my_history_(info_t *);
int my_alias_(info_t *);
int print_string_alias(list_t *node);
